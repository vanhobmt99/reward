...
!(function (e, t) {
        ...
        te(function (o, a, u, l) {
          ...
          if (o) {
            if (i || e) {
              ...
              for (f = d.length; f--; )
                (p = d[f]) &&
                  (c = i ? s.call(o, p) : h[f]) > -1 &&
                  (o[c] = !(a[c] = p));
            }
          } else
            ((d = he(d === a ? d.splice(y, d.length) : d)),
              i ? i(null, a, d, l) : v.apply(a, d));
        })
      );
    }
    function ve(e) {
            ...
            var n = t.length > 0,
              ...
              a = function (a, s, u, c, f) {
                ...
                for (
                  ...
                  if (i && d) {
                    for (
                      h = 0, s || d.ownerDocument == l || (ue(d), (u = !p));
                      (g = e[h++]);
                    )
                      if (g(d, s || l, u)) {
                        v.call(c, d);
    ...
    T.extend({
      ...
      ready: function (e) {
        (!0 === e ? --T.readyWait : T.isReady) ||
          ((T.isReady = !0),
          (!0 !== e && --T.readyWait > 0) || Y.resolveWith(v, [T]));
      },
    }),
    (T.ready.then = Y.then),
  ...
  function De(e, t, n, r, i) {
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); )
      if (r && T.inArray(o, r) > -1) i && i.push(o);
        ...
        ((l = de(o)), (a = ke(f.appendChild(o), "script")), l && je(a), n)
      )
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            Te.test(t.type) && t.click && S(t, "input") && Oe(t, "click", !0),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            Te.test(t.type) && t.click && S(t, "input") && Oe(t, "click"),
            !0
          );
        },
        _default: function (e) {
  ...
  function _e(e, t, n, r) {
    ...
    if (
      p &&
      ((a = (i = De(t, e[0].ownerDocument, !1, e, r)).firstChild),
      ...
      for (u = (s = T.map(ke(i, "script"), We)).length; f < p; f++)
        ((l = i),
          f !== g &&
            ((l = T.clone(l, !0, !0)), u && T.merge(s, ke(l, "script"))),
          n.call(e[f], l, f));
      if (u)
  ...
  function ze(e, t, n) {
    for (var r, i = t ? T.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      (n || 1 !== r.nodeType || T.cleanData(ke(r)),
        r.parentNode &&
          (n && de(r) && je(ke(r, "script")), r.parentNode.removeChild(r)));
    return e;
  }
  (T.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (a = ke(s), r = 0, i = (o = ke(e)).length; r < i; r++)
          Be(o[r], a[r]);
      if (t)
        if (n)
          for (o = o || ke(e), a = a || ke(s), r = 0, i = o.length; r < i; r++)
            $e(o[r], a[r]);
        else $e(e, s);
      return (
        (a = ke(s, "script")).length > 0 && je(a, !u && ke(e, "script")),
        s
      );
    },
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = tt(s)), (a = T.cssHooks[t] || T.cssHooks[s]), void 0 === n)
        )
        ...
        if ((u = !T.isEmptyObject(t)) || !T.isEmptyObject(d))
          ...
          d))
            (u ||
              ...
              g && xe([e], !0),
              p.done(function () {
                for (r in (g || xe([e]), ie.remove(e, "fxshow"), d))
                  T.style(e, r, d[r]);
              })),
              (u = vt(g ? v[r] : 0, r, p)),
              r in v ||
  ...
  (T.ajaxSetup({
    ...
    T.each(["top", "left"], function (e, t) {
      T.cssHooks[t] = Je(d.pixelPosition, function (e, n) {
        if (n)
          return ((n = Qe(e, t)), Xe.test(n) ? T(e).position()[t] + "px" : n);
      });
    }),
